...
pub const MANAGED_POLICY_TYP: &str = "webuild.managed_policy.v1";
pub const MANAGED_IDENTITY_TYP: &str = "webuild.managed_identity.v1";
...
mod tests {
    ...
    fn managed_identity_claim_round_trips_and_defaults() {
        ...
        let partial: ManagedIdentityClaim = serde_json::from_str(
            r#"{"typ":"webuild.managed_identity.v1","principal":"team-007","expires_at":1,"key_id":"v1"}"#,
        )
        .unwrap();
