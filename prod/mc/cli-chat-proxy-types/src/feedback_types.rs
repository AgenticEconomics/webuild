...
//!
//! These types support the feedback collection system for WeBuild sessions.
//! The agent (xai-webuild-shell) uses heuristics to determine when to request feedback,
...
pub struct FeedbackSubmission {
    ...
    /// Shell (xai-webuild-shell) version
    #[serde(skip_serializing_if = "Option::is_none")]
...
fn default_tier1_prompt() -> String {
    "You've been using WeBuild Code productively! Would you mind sharing quick feedback?".to_string()
}
