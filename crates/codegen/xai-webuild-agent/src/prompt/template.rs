...
/// The base prompt template source, exposed for `webuild prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `webuild prompt --section apply-patch-template`.
