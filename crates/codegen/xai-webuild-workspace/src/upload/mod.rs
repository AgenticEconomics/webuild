...
use xai_webuild_auth::{AuthCredentialProvider, CredentialSnapshot};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "webuild_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "webuild_workspace_upload_queue_pending",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "webuild_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "webuild_workspace_upload_skipped_total",
...
impl xai_webuild_auth::visibility::HttpAuth for HubAuthCredentialProvider {
