...
use xai_webuild_mcp::servers::McpClient;
...
/// Extract a server name from an [`McpError`](xai_webuild_mcp::servers::McpError),
/// falling back to `"unknown"`.
pub(crate) fn server_name_from_mcp_error(e: &xai_webuild_mcp::servers::McpError) -> &str {
