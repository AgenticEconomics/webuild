...
//!
//! ```text
//! <cwd>/.webuild/rewind-checkpoints/
...
/// Directory (under `<cwd>/.webuild`) holding every session's checkpoint store.
...
pub(crate) struct CheckpointStore {
    /// Per-session store directory: `<cwd>/.webuild/rewind-checkpoints/<session_id>`.
    dir: PathBuf,
