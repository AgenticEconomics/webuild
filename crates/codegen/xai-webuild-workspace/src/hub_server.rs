...
use xai_webuild_tools::implementations::webuild_build::scheduler::interval::interval_to_human;
use xai_webuild_tools::implementations::webuild_build::scheduler::types::{
    SchedulerCommand, SchedulerHandle,
};
use xai_webuild_tools::registry::types::FinalizedToolset;
use xai_webuild_tools::types::resources::Terminal;
use xai_webuild_workspace_types::rpc::workspace::{
...
static WORKSPACE_RPC_CALLER_MISMATCH_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "webuild_workspace_rpc_caller_mismatch_total",
...
static WORKSPACE_RPC_MUTATION_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "webuild_workspace_rpc_mutation_total",
...
static WORKSPACE_RPC_REQUESTS_TOTAL: std::sync::LazyLock<IntCounterVec> =
    std::sync::LazyLock::new(|| {
        register_int_counter_vec!(
            "webuild_workspace_rpc_requests_total",
...
static WORKSPACE_RPC_DURATION_SECONDS: std::sync::LazyLock<HistogramVec> =
    std::sync::LazyLock::new(|| {
        register_histogram_vec!(
            "webuild_workspace_rpc_duration_seconds",
...
) -> Vec<xai_webuild_workspace_types::rpc::workspace::BackgroundTaskSummaryWire> {
    use xai_webuild_tools::computer::types::TaskKind;
    use xai_webuild_tools::types::resources::Terminal;
    use xai_webuild_tools::types::tool::ToolKind;
    use xai_webuild_workspace_types::rpc::workspace::BackgroundTaskSummaryWire;
    let terminal = {
...
async fn list_session_todos(
    toolset: &xai_webuild_tools::registry::types::FinalizedToolset,
) -> Vec<xai_webuild_workspace_types::rpc::workspace::TodoSummaryWire> {
    use xai_webuild_tools::implementations::webuild_build::todo::{TodoState, TodoStatus};
    use xai_webuild_tools::types::resources::State;
    use xai_webuild_workspace_types::rpc::workspace::TodoSummaryWire;
    let res = toolset.resources.lock().await;
...
impl WorkspaceRpcHandler {
    ...
    async fn dispatch(
        ...
        use xai_webuild_workspace_types::rpc::git::{GitBranchInfoReq, GitMetadataReq};
        use xai_webuild_workspace_types::rpc::search::FuzzyStatusReq;
        use xai_webuild_workspace_types::rpc::skills::DiscoverPluginsReq;
        use xai_webuild_workspace_types::rpc::workspace::{
        ...
        use xai_webuild_workspace_types::rpc::worktree::WorktreeCreateSyncReq;
...
mod tests {
    ...
    use xai_webuild_tools::implementations::webuild_build::scheduler::types::ScheduledTask;
    use xai_tool_protocol::turn_hook;
    ...
    async fn list_background_tasks_rpc_stays_truthful_across_rebinds() {
        ...
        use xai_webuild_workspace_types::rpc::workspace::ListBackgroundTasksResponse;
        let handle = make_handle();
        ...
        let read_only = ToolServerConfig {
            tools: vec![tc(
                "WeBuild:read_file",
                Some(xai_webuild_tools::types::tool::ToolKind::Read),
            )],
    ...
    async fn handle_call_records_rpc_metrics_and_collapses_unknown_method() {
        ...
        let has_bogus_series = prometheus::gather()
            .iter()
            .filter(|mf| mf.name() == "webuild_workspace_rpc_requests_total")
