...
use xai_webuild_tools::types::output::ToolRunResult;
use xai_webuild_workspace_client::{WorkspaceClient, is_transport_fatal};
pub use xai_webuild_workspace_types::rpc::WorkspaceRpc;
pub use xai_webuild_workspace_types::rpc::agents_md::DiscoverAgentsMdReq;
pub use xai_webuild_workspace_types::rpc::code_nav::{
...
pub use xai_webuild_workspace_types::rpc::fs::{
...
pub use xai_webuild_workspace_types::rpc::git::{
...
pub use xai_webuild_workspace_types::rpc::hooks::{
    HookEventNameWire, HookRegistryReq, HookRegistryWire, HookSpecWire,
};
pub use xai_webuild_workspace_types::rpc::hunks::{
...
pub use xai_webuild_workspace_types::rpc::search::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
pub use xai_webuild_workspace_types::rpc::session::{BeginPromptReq, EndPromptReq, RewindToReq};
pub use xai_webuild_workspace_types::rpc::skills::DiscoverSkillsReq;
pub use xai_webuild_workspace_types::rpc::workspace::WorkspaceInfoReq;
...
fn hook_registry_to_wire(
    registry: &xai_webuild_hooks::discovery::HookRegistry,
...
) -> WorkspaceResult<xai_webuild_hooks::discovery::HookRegistry> {
    let value = serde_json::to_value(wire).map_err(|e| WorkspaceError::HubError(e.to_string()))?;
    let mut registry: xai_webuild_hooks::discovery::HookRegistry =
        serde_json::from_value(value).map_err(|e| WorkspaceError::HubError(e.to_string()))?;
...
///   session's [`FinalizedToolset`](xai_webuild_tools::registry::types::FinalizedToolset).
...
impl WorkspaceOps {
    ...
    pub async fn hook_registry(&self) -> WorkspaceResult<xai_webuild_hooks::discovery::HookRegistry> {
    ...
    ///   [`FinalizedToolset`](xai_webuild_tools::registry::types::FinalizedToolset)
...
mod tests {
    ...
    /// request types are defined in `xai-webuild-workspace-types` (and re-exported
    ...
    async fn end_local_session_drops_bound_toolset() {
        ...
        let toolset = std::sync::Arc::new(
            xai_webuild_tools::registry::types::FinalizedToolset::empty_for_test(),
        );
    ...
    fn hook_registry_wire_round_trip_both_directions() {
        let spec = xai_webuild_hooks::config::HookSpec {
            ...
            event: xai_webuild_hooks::event::HookEventName::PreToolUse,
            ...
            url_raw: None,
            timeout_ms: 5000,
            source_dir: std::path::PathBuf::from("/home/u/.webuild/hooks"),
            extra_env: std::collections::HashMap::from([("FOO".to_string(), "bar".to_string())]),
        };
        let mut registry = xai_webuild_hooks::discovery::HookRegistry::default();
    ...
    fn hook_event_name_wire_covers_all_upstream_variants() {
        use xai_webuild_hooks::event::HookEventName as E;
    ...
    /// can't depend on `xai-webuild-hooks`, and `hook_registry_to_wire` only couples
    ...
    fn hook_spec_wire_covers_all_upstream_fields() {
        use xai_webuild_hooks::config::HookSpec;
