//! AcpFsAdapter: implements `xai-webuild-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates xai-webuild-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use xai_webuild_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps xai-webuild-shell's ACP gateway to satisfy xai-webuild-tools' AsyncFileSystem.
///
