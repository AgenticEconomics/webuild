...
// its wire types live in `xai_webuild_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use xai_webuild_workspace_types::rpc::fs::FsReadEncoding;
...
pub use xai_webuild_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
