...
impl HubHandle {
    ...
    pub(crate) async fn connect(
        ...
        let mut server_builder = ToolServerBuilder::default()
            ...
            .binary_version(xai_webuild_version::VERSION)
            ...
            match transport {
                ...
                None => {
                    tracing::warn!(
                        ...
                        "WEBUILD_HITL_PERMISSION_LIVE set but no hub ToolServer; rejecting guarded tool"
                    );
                    return terminal_only(Err(ToolError::new(
                        ToolErrorKind::PermissionDenied,
...
mod tests {
    ...
    use xai_webuild_tools::types::tool_metadata::ToolMetadata as XaiToolMetadata;
    #[derive(Debug)]
    ...
    fn bg_config() -> ToolServerConfig {
        ToolServerConfig {
            tools: vec![
                ...
                tc("WeBuild:monitor", Some(ToolKind::Monitor)),
            ],
    ...
    fn bg_started_notif(task_id: &str) -> ToolNotification {
        use xai_webuild_tools::notification::types::{
    ...
    fn task_completed_notif(task_id: &str) -> ToolNotification {
        use xai_webuild_tools::computer::types::{TaskKind, TaskSnapshot};
