...
const ENV_ENABLED: &str = "WEBUILD_INSTRUMENTATION";
const ENV_LOG_PATH: &str = "WEBUILD_INSTRUMENTATION_LOG";
const DEFAULT_LOG_DIR: &str = "logs";
const DEFAULT_LOG_FILE: &str = "instrumentation.log";
const DEFAULT_TRACE_FILE: &str = "instrumentation.trace.json";

pub const TARGET: &str = "xai_webuild_instrumentation";
...
fn default_log_path() -> PathBuf {
    webuild_home().join(DEFAULT_LOG_DIR).join(DEFAULT_LOG_FILE)
}
...
fn default_output_path(mode: InstrumentationMode) -> PathBuf {
    let root = webuild_home().join(DEFAULT_LOG_DIR);
    match mode {
