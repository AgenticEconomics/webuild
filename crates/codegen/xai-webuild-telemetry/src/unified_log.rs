...
pub enum LogSource {
    ...
    #[serde(rename = "shell")]
    Shell,
    #[strum(serialize = "webuild-pager")]
    #[serde(rename = "webuild-pager")]
    WeBuildPager,
    #[strum(serialize = "webuild-desktop")]
    #[serde(rename = "webuild-desktop")]
    WeBuildDesktop,
}
...
fn log_path() -> PathBuf {
    webuild_home().join(LOG_DIR).join(LOG_FILE)
}
