...
use xai_webuild_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (xai_webuild_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    xai_webuild_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use xai_webuild_shell::tools::{TodoItem, TodoPriority};
