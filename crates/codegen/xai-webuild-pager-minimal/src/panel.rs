...
use xai_webuild_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use xai_webuild_pager::views::modal::ActiveModal;
use xai_webuild_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use ratatui::layout::Rect;
    use xai_webuild_pager::views::extensions_modal::ExtensionsModalState;
    use xai_webuild_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    ...
    fn session_entry(id: &str) -> xai_webuild_pager::app::app_view::SessionPickerEntry {
        xai_webuild_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<xai_webuild_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: xai_webuild_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: xai_webuild_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
