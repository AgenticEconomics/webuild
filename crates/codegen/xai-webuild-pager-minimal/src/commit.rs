...
use xai_webuild_pager::appearance::AppearanceConfig;
...
use xai_webuild_pager::scrollback::blocks::ToolCallBlock;
use xai_webuild_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use xai_webuild_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                xai_webuild_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
        ...
        let hunk = vec![
            xai_webuild_pager::diff::DiffLine {
                text: "let x = 1;\n".into(),
                lo: 1,
                ln: 1,
                tag: ChangeTag::Equal,
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use xai_webuild_pager::diff::DiffLine;
