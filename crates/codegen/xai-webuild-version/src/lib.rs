//! Installed webuild CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "WEBUILD_TEST_VERSION";

pub const VERSION: &str = match option_env!("WEBUILD_VERSION") {
    Some(v) => v,
