...
//!
//! Extracted from `xai-webuild-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use xai_webuild_tools::implementations::webuild_build::task::types::SubagentRuntimeOverrides;
...
mod tests {
    use super::*;
    use xai_webuild_tools::implementations::webuild_build::task::types::ModelOverrideProvenance;
    ...
    fn explicit_model_overrides_role() {
        let overrides = make_overrides(Some("webuild-light"), None, None, None, None);
        ...
        assert_eq!(result.model.as_deref(), Some("webuild-light"));
    }
