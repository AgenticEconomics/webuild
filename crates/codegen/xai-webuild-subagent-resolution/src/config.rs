...
//! `xai_webuild_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `xai-webuild-shell` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(
            ...
            Some(".webuild/prompts/researcher.md")
        );
...
"#;
        ...
        assert_eq!(
            ...
            Some(".webuild/personas/concise.md")
        );
