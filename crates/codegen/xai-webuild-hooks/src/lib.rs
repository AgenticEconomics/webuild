//! # xai-webuild-hooks
//!
//! Runtime hook system for WeBuild — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for WeBuild. Hooks are discovered
//! from dedicated directories (`~/.webuild/hooks/` and `<git-worktree-root>/.webuild/hooks/`),
...
//!     Some(Path::new("/home/user/.webuild/hooks")),
//!     Some(Path::new("/project/.webuild/hooks")),
//! );
//!
//! for err in &errors {
