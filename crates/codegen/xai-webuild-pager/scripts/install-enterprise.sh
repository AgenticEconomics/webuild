#!/bin/bash
#
# WeBuild CLI installer (enterprise channel) — https://x.ai/cli/enterprise-install.sh
#
...
# Env: WEBUILD_BIN_DIR, WEBUILD_PROXY_URL
#
# Usage:
...
#   WEBUILD_DEPLOYMENT_KEY=<key> bash <(curl -fsSL https://x.ai/cli/enterprise-install.sh)
#
...
if [ "$os" = "windows" ]; then
    ...
    chmod +x "$binary_path"
    ln -sf "$binary_path" "$BIN_DIR/webuild"
