#
# WeBuild CLI installer (enterprise channel) for PowerShell — https://x.ai/cli/enterprise-install.ps1
#
...
#   $env:WEBUILD_VERSION="0.1.42"; irm https://x.ai/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:WEBUILD_DEPLOYMENT_KEY="<key>"; irm https://x.ai/cli/enterprise-install.ps1 | iex
#
