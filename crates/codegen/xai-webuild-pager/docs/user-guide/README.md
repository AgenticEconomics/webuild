...
Automate, script, and integrate WeBuild with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `webuild -p`, output formats, CI/CD integration, and piping |
