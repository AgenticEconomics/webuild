...
|---|---|---|
| `WEBUILD_EXTERNAL_OTEL` | `0` | Master switch. Distinct from `WEBUILD_TELEMETRY_ENABLED`, which controls SpaceXAI-internal product analytics — the two govern opposite-pointing data flows. |
