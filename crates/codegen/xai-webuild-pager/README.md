...
Terminal UI (TUI) for WeBuild. Provides the interactive full-screen interface
...
- [Hook Examples](../xai-webuild-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`xai-webuild-hooks`)](../xai-webuild-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`xai-webuild-plugin-marketplace`)](../xai-webuild-plugin-marketplace/) — marketplace source loading, scanning, and install
