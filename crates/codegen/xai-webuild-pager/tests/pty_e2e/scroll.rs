...
use xai_webuild_pager_pty_harness::PtyHarness;
pub(crate) use xai_webuild_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`xai-webuild-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `xai-webuild-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
...
/// (e.g. `WEBUILD_SCROLL_SPEED`) appended to the controller's env.
