...
const HERO_SUBTITLE: &str = "Thanks for trying WeBuild, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&xai_webuild_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("WeBuild 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("WeBuild 4.5 is here. Upgrade now."));
