...
use xai_webuild_markdown::StreamingMarkdownRenderer;
pub use xai_webuild_tools::implementations::webuild_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<xai_webuild_telemetry::events::CreditLimitChoice>,
    },
    /// SuperWeBuild upsell modal: the free-usage paywall (429 +
    ...
    /// `id`.
    FreeUsageUpsell {
        /// Telemetry source for `SuperWeBuildUpsellClicked` — distinguishes
        /// the paywall from the restricted-command upsell.
        source: xai_webuild_telemetry::events::SuperWeBuildUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<xai_webuild_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    /// questions (e.g. the SuperWeBuild upsell) have no freeform row, so
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> xai_webuild_tools::implementations::webuild_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: xai_webuild_tools::implementations::webuild_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
...
mod tests {
    ...
    /// `no_freeform` questions (e.g. the SuperWeBuild upsell) have no "Other"
