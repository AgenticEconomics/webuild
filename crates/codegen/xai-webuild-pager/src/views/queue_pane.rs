...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. WeBuildNight's dark band leaking into WeBuildDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default WeBuildNight, dark) after the user switches —
        // painting a dark band on a light WeBuildDay canvas.
