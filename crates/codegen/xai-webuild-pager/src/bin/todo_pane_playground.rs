...
//!
//! ```text
//! cargo run -p xai-webuild-pager --bin todo-pane-playground
//! ```
//!
...
use xai_webuild_pager::views::todo_pane::TodoPane;
use xai_webuild_shell::tools::{TodoItem, TodoPriority, TodoStatus};
