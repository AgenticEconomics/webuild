...
// minimal rendering lives in the sibling `xai-webuild-pager-minimal` crate; these
...
// `xai-webuild-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use xai_webuild_pager_render::{
