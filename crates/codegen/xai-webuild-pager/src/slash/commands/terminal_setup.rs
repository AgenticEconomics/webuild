...
impl SlashCommand for TerminalSetupCommand {
    ...
    fn run(&self, _ctx: &mut CommandExecCtx, _args: &str) -> CommandResult {
        ...
        let container_no_display =
            xai_webuild_shell::util::clipboard::is_containerized_without_display();
        ...
        let clipboard_diagnostics = crate::diagnostics::format_clipboard_diagnostics(
            crate::diagnostics::ClipboardDiagnosticsInput {
                ...
                native_tool: xai_webuild_shell::util::clipboard::native_tool_name(),
                brand: ctx.brand,
                ...
                wayland_data_control: is_wayland
                    && xai_webuild_shell::util::clipboard::wayland_data_control_supported(),
                wl_copy_available: is_wayland
                    && xai_webuild_shell::util::clipboard::native_tool_name() == "wl-copy",
            },
        );
        out.push('\n');
