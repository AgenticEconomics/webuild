...
///
/// Delegates to the shared implementation in `xai_webuild_tools::reminders`.
...
fn format_cron_prompt(prompt: &str, task_id: &str, human_schedule: &str) -> String {
    xai_webuild_tools::reminders::format_scheduled_task_prompt(prompt, task_id, human_schedule)
}
