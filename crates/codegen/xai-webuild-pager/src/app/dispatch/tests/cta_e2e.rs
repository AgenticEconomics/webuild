...
mod cta_e2e {
    ...
    fn happy_path_with_auth_handoff() {
        ...
        let servers = vec![
            cta_mcp_server("webuild_com_managed", None, McpServerDisplayStatus::Ready),
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = xai_webuild_shell::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        xai_webuild_shell::config::add_dismissed_plugin_cta_to_file("figma", &config_path)
