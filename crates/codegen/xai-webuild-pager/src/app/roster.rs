...
/// `xai-webuild-shell/src/agent/handlers/session.rs::handle_roster_list`), which
...
mod tests {
    ...
    fn agent_entry() -> xai_webuild_shell::agent::roster::RosterEntry {
        use xai_webuild_shell::agent::roster as agent;
        agent::RosterEntry {
