...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use xai_webuild_tools::implementations::webuild_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        xai_webuild_telemetry::session_ctx::log_event(xai_webuild_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            xai_webuild_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! the SuperWeBuild upsell. Regression tests for the bug where clicking
    ...
    fn upsell_question() -> Question {
        ...
        Question {
            ...
            options: vec![
                opt("Upgrade to SuperWeBuild", "For everyday coding"),
                opt("Upgrade to SuperWeBuild Heavy", "Highest usage limits"),
            ],
