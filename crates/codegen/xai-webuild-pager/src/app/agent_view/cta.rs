...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        xai_webuild_telemetry::session_ctx::log_event(xai_webuild_telemetry::events::PromptSuggestion {
            action: xai_webuild_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        xai_webuild_telemetry::session_ctx::log_event(
            xai_webuild_telemetry::events::PluginCtaConnectClicked {
        ...
        self.pending_effects
            .push(super::actions::Effect::InstallPluginFromCta {
                agent_id: self.session.id,
                session_id,
                source_url_or_path: xai_webuild_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL
                    .to_string(),
                plugin_relative_path,
            });
    }
