                ...
                if let Err(msg) = self.prompt.insert_image(pasted) {
                    ...
                    if ctx.source.tip_showing() {
                        xai_webuild_telemetry::session_ctx::log_event(
                            xai_webuild_telemetry::events::ContextualTip {
...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question =
            xai_webuild_tools::implementations::webuild_build::ask_user_question::Question {
                question: "Pick one?".to_string(),
                options: vec![
                xai_webuild_tools::implementations::webuild_build::ask_user_question::QuestionOption
