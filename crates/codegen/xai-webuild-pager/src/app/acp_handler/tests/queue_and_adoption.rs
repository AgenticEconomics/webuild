#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn queue_changed_adopts_running_prompt_id_only_when_unset() {
        ...
        let shell_payload = xai_webuild_shell::session::prompt_queue::QueueChanged {
    ...
    fn bash_kind_round_trips_and_adoption_sets_bash_turn() {
        ...
        let shell = xai_webuild_shell::session::prompt_queue::QueueChanged {
            session_id: "sess-1".to_string(),
            entries: vec![xai_webuild_shell::session::prompt_queue::QueueEntryWire {
                id: "b1".to_string(),
                version: 0,
                owner: None,
                last_editor: None,
