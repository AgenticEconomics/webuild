...
//!
//! ```text
//! cargo bench -p xai-webuild-pager --bench edit_highlight
//! cargo bench -p xai-webuild-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use xai_webuild_pager::diff::{DiffHunk, DiffLine};
use xai_webuild_pager::scrollback::blocks::tool::{
...
use xai_webuild_pager::syntax::{Syntect, get_syntect};
