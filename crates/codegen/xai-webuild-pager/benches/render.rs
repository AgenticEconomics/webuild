//! Criterion benchmarks for the xai-webuild-pager rendering pipeline.
//!
...
use xai_webuild_pager::scrollback::render::render_scrolled_entries_with_scratch;
use xai_webuild_pager::scrollback::wrappers::EntryRenderer;
use xai_webuild_pager::scrollback::{
