# @webuild/webuild-linux-arm64

Platform-specific binary for [`@webuild/webuild`](https://www.npmjs.com/package/@webuild/webuild) on linux-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @webuild/webuild
```
