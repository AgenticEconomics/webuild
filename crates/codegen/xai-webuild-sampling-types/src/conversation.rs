...
pub struct ConversationRequest {
    ...
    pub x_webuild_conv_id: Option<String>,
    pub x_webuild_req_id: Option<String>,
    pub x_webuild_session_id: Option<String>,
    pub x_webuild_turn_idx: Option<String>,
    pub x_webuild_agent_id: Option<String>,
    pub x_webuild_deployment_id: Option<String>,
    pub x_webuild_user_id: Option<String>,
...
pub struct ConversationResponse {
    ...
    /// only, opt-in via the `x-webuild-doom-loop-check` header). Empty when the
...
// ---------------------------------------------------------------------------
//
// Part of the WeBuild Compaction unification. Lets the shared, transport-agnostic
// engine in `crates/common/xai-webuild-compaction` operate over grok-build's
...
impl xai_webuild_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> xai_webuild_compaction::CompactionRole {
        use xai_webuild_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<xai_webuild_compaction::CompactionFileRef> {
        ...
        // `WeBuildTurn`. The full-replace path does not read this; revisit if
        // image attachments need to survive into the `<webuild_user_queries>`
        // preamble.
        Vec::new()
    }
}

impl xai_webuild_compaction::CompactionItemFactory for ConversationItem {
...
/// ([stream/messages.rs:340](crates/codegen/xai-webuild-sampler/src/stream/messages.rs))
...
///
/// This is `pub` so downstream crates (`xai-webuild-shell`) can re-use it
...
impl From<ChatResponseMessage> for ConversationItem {
    fn from(msg: ChatResponseMessage) -> Self {
        ...
        // ([crates/codegen/xai-webuild-sampler/src/stream/chat_completions.rs])
...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        ChatCompletionRequest {
            ...
            x_webuild_conv_id: req.x_webuild_conv_id,
            x_webuild_req_id: req.x_webuild_req_id,
            x_webuild_session_id: req.x_webuild_session_id,
            x_webuild_turn_idx: req.x_webuild_turn_idx,
            x_webuild_agent_id: req.x_webuild_agent_id,
            x_webuild_deployment_id: req.x_webuild_deployment_id,
            x_webuild_user_id: req.x_webuild_user_id,
            trace: None,
        }
    }
}
...
impl ConversationRequest {
    ...
    pub fn with_conv_id(mut self, conv_id: impl Into<String>) -> Self {
        self.x_webuild_conv_id = Some(conv_id.into());
        self
    }

    /// Set request ID header
    pub fn with_req_id(mut self, req_id: impl Into<String>) -> Self {
        self.x_webuild_req_id = Some(req_id.into());
        self
    }
...
pub fn build_messages_request(req: &ConversationRequest) -> crate::messages::MessagesRequest {
    ...
    // output without tools. The webuild-shell agent does NOT use this path — a
...
/// ([crates/codegen/xai-webuild-sampler/src/stream/messages.rs]) instead
...
mod compaction_item_bridge_tests {
    use super::*;
    use xai_webuild_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
...
mod tests {
    ...
    fn test_transform_cwd_transforms_tool_call_arguments() {
        ...
        let worktree = "/home/user/.webuild/worktrees/project/ab-uuid-a";
    ...
    fn test_transform_cwd_worktree_to_root_syncback() {
        ...
        let worktree = "/home/user/.webuild/worktrees/myproject/fork-a";
    ...
    fn test_transform_cwd_assistant_only_tool_calls_no_content() {
        ...
        let worktree = "/home/user/.webuild/worktrees/proj/fork-a";
    ...
    fn test_conversation_request_builder() {
        ...
        assert_eq!(req.x_webuild_conv_id, Some("conv-123".to_string()));
        assert_eq!(req.x_webuild_req_id, Some("req-456".to_string()));
    ...
    #[test]
    fn upgrade_legacy_reasoning_singular_webuild_build_shape() {
