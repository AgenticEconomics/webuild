...
//! `xai_webuild_shell::session::git` and `xai_webuild_shell::extensions::git`
...
/// VCS kind.
///
/// TODO(workspace): align with `xai_webuild_shell::session::git::VcsKind`.
