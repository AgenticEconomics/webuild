...
//!   here would force every consumer of `xai-webuild-workspace-types`
...
//! (`xai-webuild-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `xai-webuild-workspace-types`
