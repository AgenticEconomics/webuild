...
/// Claude.md / `.webuild/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.webuild` and compat dirs.
...
/// Mirrors the serde shape of `xai-webuild-agent`'s `AgentConfigFile`.
