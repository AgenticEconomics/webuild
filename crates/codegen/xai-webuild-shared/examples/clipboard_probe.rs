...
//! cargo build --release -p xai-webuild-shared --example clipboard_probe
//! hyperfine --warmup 2 \
//!   -n native './target/release/examples/clipboard_probe' \
//!   -n osascript 'WEBUILD_CLIPBOARD_NO_NATIVE_READ=1 ./target/release/examples/clipboard_probe'
//! ```
//!
...
fn main() -> anyhow::Result<()> {
    ...
    let attachments = xai_webuild_shared::clipboard::get_attachments()?;
