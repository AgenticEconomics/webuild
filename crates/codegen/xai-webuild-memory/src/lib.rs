...
//! WeBuild to persist important information across sessions. Memory files are
//! stored under `~/.webuild/memory/` with workspace-scoped subdirectories
...
//! `WEBUILD_MEMORY=1` environment variable. When disabled, this crate
