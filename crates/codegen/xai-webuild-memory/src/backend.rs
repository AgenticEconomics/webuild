...
use xai_webuild_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct EndpointScopedCredentials {
    ...
    auth_credentials: Option<Arc<dyn xai_webuild_auth::AuthCredentialProvider>>,
...
impl EndpointScopedCredentials {
    ...
    fn auth_credentials(&self) -> Option<&Arc<dyn xai_webuild_auth::AuthCredentialProvider>> {
        self.auth_credentials.as_ref()
    }

    fn api_key_provider(&self) -> Option<&xai_webuild_tools::types::SharedApiKeyProvider> {
...
pub struct MemoryBackendParams {
    ...
    pub embed_config: Option<xai_webuild_config_types::MemoryEmbeddingConfig>,
    ...
    pub search_config: xai_webuild_config_types::MemorySearchConfig,
...
async fn build_embedding_provider(
    config: Option<&xai_webuild_config_types::MemoryEmbeddingConfig>,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<xai_webuild_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: xai_webuild_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: xai_webuild_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_embedding(
        mut self,
        config: xai_webuild_config_types::MemoryEmbeddingConfig,
        base_url: String,
    ...
    pub fn with_search_config(mut self, config: xai_webuild_config_types::MemorySearchConfig) -> Self {
...
impl MemoryBackendImpl {
    ...
    pub fn search_config_for_test(&self) -> &xai_webuild_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
impl MemoryBackend for MemoryBackendImpl {
    ...
    async fn search(
        ...
        let mut index = super::index::MemoryIndex::open_or_create(
            &self.db_path,
            self.storage.clone(),
            xai_webuild_config_types::MemoryIndexConfig::default(),
            embed_dims,
        )
        ...
        if needs_release {
            ...
            if let Some((dirty_count, reindexed_count, sync_start)) = watcher_sync_stats {
                xai_webuild_telemetry::session_ctx::log_event(
                    xai_webuild_telemetry::memory_telemetry::MemoryWatcherSync {
        ...
        if results.is_empty() {
            xai_webuild_telemetry::session_ctx::log_event(
                xai_webuild_telemetry::memory_telemetry::MemorySearchEmpty {
                    session_id: self.session_id.clone(),
            ...
            xai_webuild_telemetry::session_ctx::log_event(
                xai_webuild_telemetry::memory_telemetry::MemorySearch {
                    session_id: self.session_id.clone(),
                    query_length: query.len(),
                    keyword_count,
...
mod factory_tests {
    ...
    use xai_webuild_config_types::{MemoryEmbeddingConfig, MemorySearchConfig};
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: xai_webuild_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: xai_webuild_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
    ...
    async fn make_embedding_provider_uses_async_api_key_resolution() {
        ...
        let probe: xai_webuild_tools::types::SharedApiKeyProvider = Arc::new(AsyncProbe {
...
mod tests {
    ...
    async fn test_build_drops_credentials_when_request_url_differs() {
        let session: xai_webuild_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        ...
        let config = xai_webuild_config_types::MemoryEmbeddingConfig {
    ...
    async fn test_trusted_endpoint_prefers_session_credential() {
        struct StubAuth;
        impl xai_webuild_auth::HttpAuth for StubAuth {
            fn apply(
                &self,
        ...
        #[async_trait::async_trait]
        impl xai_webuild_auth::AuthCredentialProvider for StubAuth {
            fn snapshot(&self) -> xai_webuild_auth::CredentialSnapshot {
                xai_webuild_auth::CredentialSnapshot::default()
            }
        ...
        let auth: Arc<dyn xai_webuild_auth::AuthCredentialProvider> = Arc::new(StubAuth);
        let api_key: xai_webuild_tools::types::SharedApiKeyProvider = Arc::new(PanicKey);
        let scoped = EndpointScopedCredentials::for_endpoint(
            "https://api.x.ai/v1",
            |_| true,
            Some(auth),
    ...
    fn endpoint_scoped_credentials_trust_gate_and_url_match() {
        struct AnyKey;
        impl xai_webuild_tools::types::ApiKeyProvider for AnyKey {
            fn current_api_key(&self) -> Option<String> {
                None
            }
        }
        let key = || Arc::new(AnyKey) as xai_webuild_tools::types::SharedApiKeyProvider;
