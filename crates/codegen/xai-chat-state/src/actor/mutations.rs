...
impl ChatStateActor {
        ...
        self.state
            ...
            .map(|item| match item {
                ...
                ConversationItem::Reasoning(r) => {
                    xai_webuild_sampling_types::reasoning_item_text(r).len()
    ...
    pub(super) fn record_last_turn_usage(&mut self, usage: xai_webuild_sampling_types::TokenUsage) {
    ...
    pub(super) fn record_model_call_usage(
        ...
        usage: &xai_webuild_sampling_types::TokenUsage,
