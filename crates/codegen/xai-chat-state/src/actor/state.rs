...
pub fn estimate_tool_definition_tokens(td: &xai_webuild_sampling_types::ToolDefinition) -> u64 {
...
pub fn estimate_tool_definitions_tokens(tds: &[xai_webuild_sampling_types::ToolDefinition]) -> u64 {
...
pub fn estimate_item_tokens(item: &ConversationItem) -> u64 {
    ...
    match item {
        ...
        ConversationItem::Reasoning(r) => {
            ...
            let text_bytes = xai_webuild_sampling_types::reasoning_item_text(r).len();
...
/// grok-build's [`ItemTokenCounter`](xai_webuild_compaction::ItemTokenCounter)
...
impl xai_webuild_compaction::ItemTokenCounter<ConversationItem> for EstimatedItemTokenCounter {
...
mod tests {
    ...
    fn estimated_item_token_counter_matches_estimate_item_tokens() {
        use xai_webuild_compaction::ItemTokenCounter;
    ...
    fn estimate_tool_definition_tokens_counts_name_desc_params() {
        ...
        let td = xai_webuild_sampling_types::ToolDefinition::function(
            "search",
            Some("find a file"),
            serde_json::json!({}),
        );
    ...
    fn estimate_tool_definitions_tokens_sums_across_slice() {
        let a = xai_webuild_sampling_types::ToolDefinition::function(
            "a",
            None::<&str>,
            serde_json::json!({}),
        );
        let b = xai_webuild_sampling_types::ToolDefinition::function(
            "b",
            None::<&str>,
            serde_json::json!({}),
        );
