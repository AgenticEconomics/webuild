//! MCP server configuration value types, extracted from xai-webuild-shell
...
use xai_webuild_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("WEBUILD_RELAY_SYNC_ENABLED") {
