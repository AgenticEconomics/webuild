...
//!
//! In dev mode, watches ~/.webuild/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.webuild/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.webuild/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = xai_webuild_config::user_webuild_home()
