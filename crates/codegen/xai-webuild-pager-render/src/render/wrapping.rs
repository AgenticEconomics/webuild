...
///
/// The selection layer's stricter, style-aware twin lives in xai-webuild-pager
...
mod tests {
    ...
    fn real_markdown_link_underline_does_not_leak_after_wrap() {
        ...
        let (out, _) = xai_webuild_markdown::render_markdown_ratatui_full(md, md_style, true, None);
