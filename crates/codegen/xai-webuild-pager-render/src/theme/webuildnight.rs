//! WeBuildNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// WeBuildNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_webuildnight_theme() {
        let theme = Theme::webuildnight();
