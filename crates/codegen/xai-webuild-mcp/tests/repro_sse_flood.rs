...
//!
//! Run with: cargo test -p xai-webuild-mcp --test repro_sse_flood -- --nocapture
...
use xai_webuild_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use xai_webuild_mcp::rmcp::ServiceExt;
use xai_webuild_mcp::rmcp::transport::StreamableHttpClientTransport;
use xai_webuild_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
