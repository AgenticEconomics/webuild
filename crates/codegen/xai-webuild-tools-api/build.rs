fn main() {
    xai_proto_build::configure()
        ...
        .field_attribute(
            ".xai.webuild.tools.v1.ToolConfigEntry.params_json",
            "#[serde(default)]",
        )
        .field_attribute(
            ".xai.webuild.tools.v1.ToolConfigEntry.name_override",
            "#[serde(default)]",
        )
        .field_attribute(
            ".xai.webuild.tools.v1.ToolConfigEntry.params_name_overrides",
            "#[serde(default)]",
        )
        .field_attribute(
            ".xai.webuild.tools.v1.ToolConfigEntry.behavior_version",
            "#[serde(default)]",
        )
        .field_attribute(
            ".xai.webuild.tools.v1.ToolConfigEntry.description_override",
            "#[serde(default)]",
        )
        .compile_protos(&["proto/webuild-tools.proto"], &["proto/"])
        .unwrap();
}
