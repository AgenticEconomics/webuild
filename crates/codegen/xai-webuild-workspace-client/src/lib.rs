...
//! `xai-webuild-workspace`. Wire types live in
//! `xai_webuild_workspace_types::rpc`; this crate adds the connected-state
...
use xai_webuild_workspace_types::rpc::agents_md::{AgentConfigFile, DiscoverAgentsMdReq};
use xai_webuild_workspace_types::rpc::code_nav::{
...
use xai_webuild_workspace_types::rpc::fs::{
...
use xai_webuild_workspace_types::rpc::git::{
...
use xai_webuild_workspace_types::rpc::hunks::{
...
use xai_webuild_workspace_types::rpc::search::{
    ContentSearchData, ContentSearchRequest, FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq,
    FuzzyStatusReq,
};
use xai_webuild_workspace_types::rpc::session::{
    BeginPromptReq, EndPromptReq, FileRewindResponse, RewindToReq,
};
use xai_webuild_workspace_types::rpc::skills::{DiscoverPluginsReq, DiscoverSkillsReq, SkillInfo};
...
use xai_webuild_workspace_types::rpc::worktree::{
...
use xai_webuild_workspace_types::rpc::{RpcEnvelope, RpcError, WORKSPACE_RPC_TOOL_ID, WorkspaceRpc};
...
mod tests {
    ...
    use xai_webuild_workspace_types::rpc::skills::SkillScope;
        ...
        async fn run(&self, _ctx: ToolCallContext, args: Self::Args) -> Result<RawOut, ToolError> {
            ...
            match args.method.as_str() {
                ...
                "workspace.discover_skills" => ok(serde_json::json!(
                    ...
                    "path" : "/workspace/.webuild/skills/my-skill/SKILL.md", "scope"
                    : "local", }]
                )),
