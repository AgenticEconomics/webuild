//! Shared helpers for xai-webuild-shell integration tests.

use xai_webuild_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `xai_webuild_sampler::SamplingClient`, which takes a
