...
//
// State is persisted to `~/.webuild/claude_import_state.json`.
...
use xai_webuild_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.webuild/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::webuild_home::webuild_home().join("claude_import_state.json")
}
