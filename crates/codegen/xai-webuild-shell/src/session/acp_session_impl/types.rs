...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<xai_webuild_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(xai_webuild_tools::implementations::webuild_build::update_goal::UpdateGoalInput),
    Channel(xai_webuild_tools::implementations::webuild_build::update_goal::UpdateGoalEnvelope),
}
