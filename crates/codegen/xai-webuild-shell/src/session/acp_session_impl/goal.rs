...
impl RoleCapability {
    ...
    fn is_satisfied(
        self,
        summary: &xai_webuild_tools::implementations::webuild_build::task::types::SubagentTypeSummary,
    ) -> bool {
        match self {
...
impl SessionActor {
    ...
    pub(super) async fn drain_goal_updates_with_extra(
        ...
        extra: Vec<xai_webuild_tools::implementations::webuild_build::update_goal::UpdateGoalEnvelope>,
    ) {
    ...
    pub(crate) async fn resolve_goal_role_override(
        ...
        if xai_webuild_agent::config::is_strict_harness_agent_type(&pair.agent_type)
    ...
    pub(super) async fn prune_prior_goal_continuation_directives(&self) {
        use xai_webuild_sampling_types::conversation::SyntheticReason;
