...
mod tests {
    use super::*;
    use xai_webuild_sampling_types::{AssistantItem, UserItem};
    ...
    fn user(text: &str) -> ConversationItem {
        ConversationItem::User(UserItem {
            content: vec![xai_webuild_sampling_types::ContentPart::Text { text: text.into() }],
    ...
    fn evidence_packet_with_file_path_renders_path_not_content() {
        let packet = build_classifier_evidence_packet(
            ...
            Some(Path::new("/home/u/.webuild/sessions/s1/goal/plan.md")),
            None,
            "I did it.",
        );
        assert_eq!(
            ...
            "OBJECTIVE:\ndo X\n\n\
             ...
             CHANGED_FILES:\n- js/main.js\n\n\
             PLAN_FILE: /home/u/.webuild/sessions/s1/goal/plan.md\n\n\
             PLAN_CHANGES: (none)\n\n\
             FINAL_RESPONSE:\nI did it.\n",
        );
    }
    ...
    fn evidence_packet_plan_path_with_spaces_and_unicode_round_trips() {
        let plan = "/tmp/webuild sessions/✓ goal/plan.md";
        let packet = build_classifier_evidence_packet(
            "obj",
            ChangesRef::Unavailable,
            &[],
