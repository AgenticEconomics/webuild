...
//! content blocks, the session calls a vision-capable WeBuild model
...
use xai_webuild_tools::util::truncate::truncate_middle;
...
impl ImageDescribeCache {
    ...
    pub async fn get_or_describe(
        &self,
        client: xai_webuild_sampler::SamplingClient,
        model: &str,
        raw_bytes: &[u8],
        mime_type: &str,
        outline: Option<&str>,
...
mod tests {
    use super::*;
    use xai_webuild_sampling_types::conversation::{ConversationItem, UserItem};
    #[test]
    ...
    fn user(text: &str) -> ConversationItem {
        ConversationItem::User(UserItem {
            content: vec![xai_webuild_sampling_types::conversation::ContentPart::Text {
                text: text.into(),
            }],
            synthetic_reason: None,
            ..Default::default()
