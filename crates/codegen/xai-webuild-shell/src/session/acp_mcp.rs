...
//!
//! The official `webuild-agent-sdk` lets a host define in-process tools (`@tool` /
...
use xai_webuild_mcp::acp_transport::AcpReverseInvoker;
use xai_webuild_mcp::servers::AcpServerEntry;
