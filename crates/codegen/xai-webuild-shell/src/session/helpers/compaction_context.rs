...
//! shell-specific types (`xai_webuild_tools::MemoryBackend`, memory context).
//!
...
//! [`xai_webuild_compaction::reminder`] so webuild-chat and grok-build stay in lockstep.
...
use xai_webuild_compaction::reminder::{
...
pub fn to_system_reminder_sync(
    ...
    skills: &[xai_webuild_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_webuild_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn xai_webuild_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[xai_webuild_tools::implementations::skills::types::SkillInfo],
    memory_results: &[xai_webuild_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        xai_webuild_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use xai_webuild_tools::implementations::search_tool::format_compaction_server_line;
