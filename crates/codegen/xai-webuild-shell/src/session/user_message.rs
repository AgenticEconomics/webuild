...
pub async fn compute_vcs_status_block(
    ...
    use xai_webuild_workspace::file_system::{git_status, jj_status};
...
mod tests {
    use super::*;
    use xai_webuild_workspace::file_system::FsError;
    ...
    async fn construct_user_message_returns_without_git_status_on_bad_dir() {
        let dir = std::path::Path::new("/tmp/nonexistent-webuild-test-dir");
