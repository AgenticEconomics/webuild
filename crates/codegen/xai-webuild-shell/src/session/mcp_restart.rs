...
//! window containing a [`xai_webuild_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`xai_webuild_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`xai_webuild_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`xai_webuild_mcp::servers::ClientStateKind::Empty`]
...
use xai_webuild_mcp::servers::{McpClientEventKind, McpServerName};
