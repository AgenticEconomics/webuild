...
async fn create_injection_ready_actor(
    initial_conversation: Vec<xai_webuild_sampling_types::ConversationItem>,
) -> SessionActor {
    ...
    local
        .run_until(async {
            let actor = create_injection_ready_actor(vec![
                xai_webuild_sampling_types::ConversationItem::system("You are a helpful assistant."),
                xai_webuild_sampling_types::ConversationItem::user(
        ...
        .run_until(async {
            let persisted_block =
                crate::session::helpers::memory_context::format_memory_reminder(&[
                    xai_webuild_tools::types::memory_backend::MemorySearchResult {
                ...
                .unwrap();
            let actor = create_injection_ready_actor(vec![
                xai_webuild_sampling_types::ConversationItem::system(format!(
