...
use xai_webuild_tools::types::tool_index::{
...
mod tests {
    ...
    fn search_underscore_joined_identifier_components() {
        let tools = vec![
            ToolMetadata {
                qualified_name: "webuild_com_chronosphere__query_prometheus_range".into(),
                server_name: "webuild_com_chronosphere".into(),
            ...
            ToolMetadata {
                qualified_name: "webuild_com_chronosphere__list_metrics".into(),
                server_name: "webuild_com_chronosphere".into(),
        ...
        let names: Vec<&str> = snap.results.iter().map(|r| r.tool_name.as_str()).collect();
        assert!(names.contains(&"webuild_com_chronosphere__query_prometheus_range"));
        assert!(names.contains(&"webuild_com_chronosphere__list_metrics"));
        ...
        assert_eq!(
            ...
            "webuild_com_chronosphere__query_prometheus_range"
        );
    }
    ...
    fn split_mixed_formats() {
        assert_eq!(
            split_identifier("webuild_com_slack__slack_send_message"),
            vec!["webuild", "com", "slack", "slack", "send", "message"]
        );
    }
    ...
    fn mcp_format_tools() -> Vec<ToolMetadata> {
        vec![
            ...
            ToolMetadata {
                qualified_name: "webuild_com_slack__slack_send_message".into(),
                server_name: "webuild_com_slack".into(),
            ...
            ToolMetadata {
                qualified_name: "webuild_com_chronosphere__QueryPrometheusRange".into(),
                server_name: "webuild_com_chronosphere".into(),
    ...
    fn fmt_exact_snake_server_snake_tool() {
        ...
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("webuild_com_slack__slack_send_message", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "webuild_com_slack__slack_send_message"
        );
    }
    ...
    fn fmt_exact_snake_server_pascal_tool() {
        ...
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("webuild_com_chronosphere__QueryPrometheusRange", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "webuild_com_chronosphere__QueryPrometheusRange"
        );
    }
    ...
    fn fmt_snake_server_only_falls_through() {
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("webuild_com_slack", 5);
        for r in &snap.results {
            assert_ne!(
                r.tool_name, "webuild_com_slack",
                "should not match a bare server name as a tool"
            );
        }
    }
    ...
    fn production_haystack() -> Vec<ToolMetadata> {
        ...
        vec![
            // ── webuild_com_slack (17 tools) ───────────────────────────
            tool(
                "webuild_com_slack__slack_create_canvas",
                "webuild_com_slack",
                "slack_create_canvas",
            ...
            tool(
                "webuild_com_slack__slack_get_reactions",
                "webuild_com_slack",
                "slack_get_reactions",
            ...
            tool(
                "webuild_com_slack__slack_list_channel_members",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_read_canvas",
                "webuild_com_slack",
                "slack_read_canvas",
            ...
            tool(
                "webuild_com_slack__slack_read_channel",
                "webuild_com_slack",
                "slack_read_channel",
            ...
            tool(
                "webuild_com_slack__slack_read_file",
                "webuild_com_slack",
                "slack_read_file",
            ...
            tool(
                "webuild_com_slack__slack_read_thread",
                "webuild_com_slack",
                "slack_read_thread",
            ...
            tool(
                "webuild_com_slack__slack_read_user_profile",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_schedule_message",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_search_channels",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_search_emojis",
                "webuild_com_slack",
                "slack_search_emojis",
            ...
            tool(
                "webuild_com_slack__slack_search_public",
                "webuild_com_slack",
                "slack_search_public",
            ...
            tool(
                "webuild_com_slack__slack_search_public_and_private",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_search_users",
                "webuild_com_slack",
                "slack_search_users",
            ...
            tool(
                "webuild_com_slack__slack_send_message_draft",
                "webuild_com_slack",
            ...
            tool(
                "webuild_com_slack__slack_update_canvas",
                "webuild_com_slack",
                "slack_update_canvas",
    ...
    fn haystack_exact_qualified_name() {
        ...
        let snap = index.search_snapshot("webuild_com_slack__slack_search_public", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "webuild_com_slack__slack_search_public"
    ...
    fn haystack_disambiguate_search_public_vs_private() {
        ...
        let pub_pos = names
            .iter()
            .position(|n| *n == "webuild_com_slack__slack_search_public");
        let priv_pos = names
            .iter()
            .position(|n| *n == "webuild_com_slack__slack_search_public_and_private");
        assert!(
            pub_pos.is_some(),
    ...
    fn score_comparison_query_normalization() {
        ...
        let cases: &[(&str, &str)] = &[
            ...
            ("search_public", "webuild_com_slack__slack_search_public"),
