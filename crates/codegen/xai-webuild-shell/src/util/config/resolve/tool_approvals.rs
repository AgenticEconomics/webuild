...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "WEBUILD_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`WEBUILD_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `WEBUILD_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
