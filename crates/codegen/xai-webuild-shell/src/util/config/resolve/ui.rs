...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "WEBUILD_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`WEBUILD_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "WEBUILD_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`WEBUILD_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "WEBUILD_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`WEBUILD_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `WEBUILD_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("WEBUILD_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes WEBUILD_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
