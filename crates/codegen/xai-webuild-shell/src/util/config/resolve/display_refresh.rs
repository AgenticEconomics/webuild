...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "WEBUILD_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "WEBUILD_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`WEBUILD_MIN_DRAW_MS` / `WEBUILD_SCROLL_CADENCE_MS`).
