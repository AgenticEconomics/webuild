...
//!
//! The canonical types now live in `xai_webuild_sampling_types::conversation`.
//! This module re-exports them and adds webuild-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use xai_webuild_sampling_types::conversation::*;

// ============================================================================
// webuild-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `xai-webuild-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in xai-webuild-sampling-types crate.
