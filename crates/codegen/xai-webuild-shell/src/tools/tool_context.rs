...
//! xai-webuild-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use xai_webuild_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use xai_webuild_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn xai_webuild_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<xai_webuild_tools::implementations::webuild_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = xai_webuild_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
