//! Retry utilities — re-exported from `xai-webuild-tools`.
//!
//! The canonical implementation now lives in `xai_webuild_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use xai_webuild_tools::retry::BackoffConfig as RetryConfig;
pub use xai_webuild_tools::retry::{BackoffConfig, execute_with_backoff};
