...
//! (SuperWeBuild, SuperWeBuild Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("SuperWeBuild"));
        assert!(!is_restricted_tier_name("SuperWeBuild Heavy"));
        assert!(!is_restricted_tier_name("superwebuild_lite"));
