...
use xai_webuild_tools::implementations::webuild_build::task::types::{SubagentRequest, SubagentResult};
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        sampling_config: xai_webuild_sampler::SamplerConfig {
            api_key: None,
            base_url: String::new(),
            model: String::new(),
        ...
        fs: Arc::new(xai_webuild_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-webuild-test"),
        ...
        parent_skills: None,
        parent_skills_config: xai_webuild_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: xai_webuild_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: xai_webuild_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl xai_webuild_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &xai_webuild_tools::implementations::lsp::LspToolInput,
    ) -> xai_webuild_tools::implementations::lsp::LspToolResult {
        xai_webuild_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<xai_webuild_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<xai_webuild_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
