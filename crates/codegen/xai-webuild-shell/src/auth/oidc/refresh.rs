...
use super::super::WeBuildAuth;
use super::protocol::{OidcError, OidcUserInfo, build_webuild_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &WeBuildAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_webuild_auth(tokens, user_info, issuer, client_id);
