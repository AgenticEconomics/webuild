...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<WeBuildAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: WeBuildAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, WeBuildAuth, WeBuildComConfig};
