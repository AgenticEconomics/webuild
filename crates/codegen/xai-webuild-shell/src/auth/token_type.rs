...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&WeBuildAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> xai_webuild_telemetry::events::AuthTokenKind {
        use xai_webuild_telemetry::events::AuthTokenKind as K;
        match self {
