...
mod tests {
    ...
    fn parse_queue_edit_command_maps_each_method() {
        ...
        match parse_queue_edit_command("x.ai/queue/remove", &p, Some("webuild-tui".into())) {
            Some(SessionCommand::RemoveQueuedPrompt {
                id,
                expected_version,
                owner,
                ...
                assert_eq!(owner.as_deref(), Some("webuild-tui"));
            }
        ...
        match parse_queue_edit_command("x.ai/queue/edit", &p, Some("webuild-vscode".into())) {
            Some(SessionCommand::EditQueuedPrompt {
                id,
                new_text,
                editor,
                ...
                assert_eq!(editor.as_deref(), Some("webuild-vscode"));
            }
        ...
        match parse_queue_edit_command("x.ai/queue/interject", &p, Some("webuild-tui".into())) {
            Some(SessionCommand::InterjectQueuedPrompt {
                id,
                expected_version,
                owner,
