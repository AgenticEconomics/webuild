...
use xai_webuild_agent::prompt::skills::{
...
fn discover_auto_sources(cwd: &str, skills: &[SkillInfo]) -> Vec<(String, usize)> {
    ...
    for subdir in &subdirs {
        try_add_source(webuild_home.join(subdir), None);
    }
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "x.ai/skills/add" => {
            ...
            .await
            {
                xai_webuild_telemetry::session_ctx::log_event(
                    xai_webuild_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            xai_webuild_telemetry::session_ctx::log_event(xai_webuild_telemetry::events::SkillAdded {
        ...
        "x.ai/skills/remove" => {
            ...
            {
                xai_webuild_telemetry::session_ctx::log_event(
                    xai_webuild_telemetry::events::SkillRemoved { success: false },
                );
            ...
            xai_webuild_telemetry::session_ctx::log_event(xai_webuild_telemetry::events::SkillRemoved {
                success: true,
            });
