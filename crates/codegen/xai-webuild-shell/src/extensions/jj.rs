//! Jujutsu extension handlers — delegates to [`xai_webuild_workspace::session::jj`].

use agent_client_protocol as acp;

use super::{Empty, ExtResult, to_ext_response, to_ext_response_partial};
use xai_webuild_workspace::session::git::{CommitData, StageData};
use xai_webuild_workspace::session::jj;
