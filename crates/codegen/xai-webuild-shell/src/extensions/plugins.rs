...
pub fn loaded_plugin_to_info(plugin: &xai_webuild_agent::plugins::LoadedPlugin) -> PluginInfo {
    use xai_webuild_agent::plugins::discovery::PluginScope as AgentScope;
...
fn origin_to_dto(origin: &xai_webuild_agent::plugins::PluginOrigin) -> PluginOrigin {
    use xai_webuild_agent::plugins::PluginOrigin as AgentOrigin;
    match origin {
        AgentOrigin::CliOverride => PluginOrigin::CliOverride,
        AgentOrigin::ProjectWeBuild => PluginOrigin::ProjectWeBuild,
        AgentOrigin::ProjectClaude => PluginOrigin::ProjectClaude,
        AgentOrigin::UserWeBuild => PluginOrigin::UserWeBuild,
...
mod tests {
    use super::*;
    use xai_webuild_agent::plugins::PluginOrigin as AgentOrigin;
    use xai_webuild_agent::plugins::discovery::{PluginId, PluginScope as AgentScope};

    fn make_loaded_plugin(origin: AgentOrigin) -> xai_webuild_agent::plugins::LoadedPlugin {
        let root = std::path::PathBuf::from("/tmp/test-plugin");
        xai_webuild_agent::plugins::LoadedPlugin {
