...
use crate::implementations::webuild_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::webuild_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::webuild_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::webuild_build::grep::GrepSearchInput;
use crate::implementations::webuild_build::image_edit::ImageEditInput;
use crate::implementations::webuild_build::image_gen::ImageGenInput;
use crate::implementations::webuild_build::list_dir::ListDirInput;
use crate::implementations::webuild_build::read_file::ReadFileInput;
use crate::implementations::webuild_build::search_replace::SearchReplaceInput;
use crate::implementations::webuild_build::todo::TodoWriteInput;
use crate::implementations::webuild_build::update_goal::UpdateGoalInput;
use crate::implementations::webuild_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::webuild_build::web_fetch::WebFetchInput;
use crate::implementations::webuild_build::web_search::WebSearchInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::webuild_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::webuild_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::webuild_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::webuild_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::webuild_build::scheduler::list::SchedulerListInput),
