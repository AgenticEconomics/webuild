...
///
/// Use with `#[schemars(with = "WeBuildIntegerSchema")]` on `Option<usize>` fields.
pub struct WeBuildIntegerSchema;
impl schemars::JsonSchema for WeBuildIntegerSchema {
    fn schema_name() -> std::borrow::Cow<'static, str> {
        "webuild_integer_schema".into()
    }
