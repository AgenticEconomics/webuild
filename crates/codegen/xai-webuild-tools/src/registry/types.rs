use crate::{
    ...
    implementations::{
        codex, webuild_build, webuild_build_concise, webuild_build_hashline, opencode,
...
/// this crate: instead of `xai-webuild-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::webuild_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::webuild_build::web_fetch::WebFetchConfig,
    ...
    pub image_gen_config: crate::implementations::webuild_build::image_gen::ImageGenConfig,
    ...
    pub video_gen_config: crate::implementations::webuild_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::webuild_build::deploy_app::AppBuilderDeployerConfig,
...
impl ToolRegistryBuilder {
    ...
    /// Fully-qualified tool id (`"WeBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<webuild_build::BashTool, webuild_build::bash::BashParams>();
        b.register_with_params::<webuild_build::ReadFileTool, webuild_build::read_file::ReadFileParams>();
        b.register_with_params::<
                webuild_build::SearchReplaceTool,
                webuild_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<webuild_build::ListDirTool, webuild_build::list_dir::ListDirParams>();
        b.register_with_params::<webuild_build::GrepTool, webuild_build::grep::GrepParams>();
        b.register::<webuild_build::KillTaskTool>();
        b.register::<webuild_build::KillTerminalCommandTool>();
        b.register::<webuild_build::TodoWriteTool>();
        b.register::<webuild_build::UpdateGoalTool>();
        b.register::<webuild_build::TaskOutputTool>();
        b.register::<webuild_build::GetTerminalCommandOutputTool>();
        b.register::<webuild_build::WaitTasksTool>();
        b.register::<webuild_build::TaskTool>();
        b.register::<webuild_build::WebSearchTool>();
        b.register_with_params::<webuild_build::WebFetchTool, webuild_build::web_fetch::WebFetchParams>();
        b.register::<webuild_build::LspTool>();
        b.register::<webuild_build::ImageGenTool>();
        b.register::<webuild_build::ImageEditTool>();
        b.register::<webuild_build::ImageToVideoTool>();
        b.register::<webuild_build::ReferenceToVideoTool>();
        b.register::<webuild_build::EnterPlanModeTool>();
        b.register::<webuild_build::ExitPlanModeTool>();
        b.register_with_params::<
                webuild_build::AskUserQuestionTool,
                webuild_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<webuild_build::MonitorTool>();
        b.register::<webuild_build::SchedulerCreateTool>();
        b.register::<webuild_build::SchedulerDeleteTool>();
        b.register::<webuild_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                webuild_build_concise::ReadFileConciseTool,
                webuild_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                webuild_build_concise::SearchReplaceConciseTool,
                webuild_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                webuild_build_concise::BashConciseTool,
                webuild_build::bash::BashParams,
            >();
        b.register_with_params::<
                webuild_build_hashline::HashlineReadTool,
                webuild_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                webuild_build_hashline::HashlineEditTool,
                webuild_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                webuild_build_hashline::HashlineGrepTool,
                webuild_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] = &[
                "WeBuild:read_file",
                "WeBuild:search_replace",
                "WeBuild:grep",
            ];
            let hashline_file_ids: &[&str] = &[
                "WeBuildHashline:hashline_read",
                "WeBuildHashline:hashline_edit",
                "WeBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if ctx.image_gen_config.has_credentials() {
            match crate::implementations::webuild_build::image_gen::ImageGenClient::new(
        ...
        if ctx.video_gen_config.is_enabled() {
            match crate::implementations::webuild_build::video_gen::VideoGenClient::new(
        ...
        if let crate::implementations::webuild_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::webuild_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::WeBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::webuild_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::webuild_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::webuild_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::webuild_build::scheduler::actor::SchedulerActor {
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "WeBuild:get_task_output" => {
            let has_webuild_build_bash = has_tool_with_bool_param(
                proposed,
                "WeBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_webuild_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "WeBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "WeBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "WeBuild", "run_terminal_cmd")
                && !has_webuild_build_bash
            {
                notes
                    .push(
                        "WeBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "WeBuildConcise", "run_terminal_cmd")
                && !has_webuild_build_concise_bash
            {
                notes
                    .push(
                        "WeBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (WeBuild:run_terminal_cmd or WeBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or WeBuild:task"
                .to_string();
            let has_provider = has_webuild_build_bash || has_webuild_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or WeBuild:task",
                )
                .with_category("requirements")
        }
        "WeBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as WeBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "WeBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires WeBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include WeBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "WeBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires WeBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include WeBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::webuild_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::webuild_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
                crate::implementations::webuild_build::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::webuild_build::deploy_app::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `webuild_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "WeBuild:search_replace".to_string(),
                    params: Some(
                        serde_json::json!({
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "WeBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full WeBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::webuild_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("WeBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (webuild).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let webuild = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("WeBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("WeBuild:get_task_output".to_string()),
                        ToolConfig::from_id("WeBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("webuild toolset should finalize");
        assert_eq!(
            webuild.tool_name_for_kind(ToolKind::Execute).as_deref(),
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({ "id" : "WeBuild:read_file", "kind" : "read" }));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({ "id" : "WeBuild:read_file", "kind" : "raed" }));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({ "id" : "WeBuild:read_file" }));
    ...
    /// Verify WeBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "WeBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "WeBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "WeBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<webuild_build::GrepTool>(),
                ToolConfig::for_tool::<webuild_build::KillTaskTool>(),
                ToolConfig::for_tool::<webuild_build::TaskOutputTool>(),
                ToolConfig {
                    id: "WeBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "WeBuild:run_terminal_cmd",
            "WeBuild:read_file",
            "WeBuild:search_replace",
            "WeBuild:list_dir",
            "WeBuild:grep",
            "WeBuild:get_terminal_command_output",
            "WeBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("WeBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("WeBuild:run_terminal_cmd", ToolKind::Execute),
            ("WeBuild:read_file", ToolKind::Read),
            ("WeBuild:search_replace", ToolKind::Edit),
            ("WeBuild:grep", ToolKind::Search),
            ("WeBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("WeBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `WeBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "WeBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "WeBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "WeBuildHashline:hashline_read".to_string(),
                params: Some(
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<webuild_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<webuild_build::ReadFileTool>(),
                ToolConfig::for_tool::<webuild_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "WeBuild:task"
                && e.message.contains("WeBuild:get_task_output")
                && e.message.contains("WeBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "WeBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "WeBuild:task" && e.message.contains("WeBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "WeBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("WeBuild:run_terminal_cmd"),
                tool("WeBuild:task"),
                tool("WeBuild:get_task_output"),
                tool("WeBuild:wait_tasks"),
                tool("WeBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("WeBuild:get_task_output"));
        assert!(error.message.contains("WeBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "WeBuild:task");
        assert!(error.message.contains("WeBuild:get_task_output"));
        assert!(error.message.contains("WeBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "WeBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "WeBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "WeBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("WeBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("WeBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("WeBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("WeBuildHashline:hashline_read"),
                hashline_tool_config("WeBuildHashline:hashline_edit"),
                hashline_tool_config("WeBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("WeBuild:read_file"),
                hashline_tool_config("WeBuild:search_replace"),
                hashline_tool_config("WeBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<webuild_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<webuild_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "WeBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<webuild_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<webuild_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<webuild_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "WeBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background" : true })
                    .as_object()
                    .unwrap()
    ...
    async fn webuild_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<webuild_build::ListDirTool>(),
                ToolConfig::for_tool::<webuild_build::ReadFileTool>(),
                ToolConfig::for_tool::<webuild_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<webuild_build::TaskOutputTool>(),
                ToolConfig::for_tool::<webuild_build::KillTaskTool>(),
                ToolConfig::for_tool::<webuild_build::GrepTool>(),
                ToolConfig::for_tool::<webuild_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = webuild_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = webuild_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<webuild_build::ListDirTool>()],
            behavior_preset: None,
        };
