...
//! ## Plan File
//!
//! The plan file path defaults to `.webuild/plan.md` relative to the session
...
Use this after you have finished writing your plan to the plan file in plan mode."#
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        use crate::implementations::webuild_build::enter_plan_mode::EnterPlanModeTool;
...
mod tests {
    ...
    async fn exit_with_plan_content() {
        ...
        let plan_dir = tmp.path().join(".webuild");
        ...
        match result {
            ExitPlanModeOutput::PlanReady {
                ...
                assert!(plan_file_path.ends_with(".webuild/plan.md"));
            }
    ...
    async fn sends_plan_mode_exited_notification_with_content() {
        ...
        match notification {
            ToolNotification::PlanModeExited(exited) => {
                ...
                assert!(exited.plan_file_path.ends_with(".webuild/plan.md"));
            }
    ...
    async fn prompt_format_includes_plan_content() {
        ...
        assert!(prompt.contains(".webuild/plan.md"));
