...
const XAI_VIDEO_BASE_MODEL: &str = "webuild-imagine-video";
const XAI_VIDEO_QUALITY_MODEL: &str = "webuild-imagine-video-1.5-preview";
...
const DEFAULT_ZDR_VIDEO_KEY_PREFIX: &str = "webuild-videos/";
...
pub struct VideoGenClient {
    ...
    /// and return the SuperWeBuild upsell prose. See [`VideoGenClient::is_tier_restricted`].
...
impl VideoGenClient {
    ...
    /// SuperWeBuild upsell instead of issuing a doomed request.
...
pub enum VideoGenConfig {
    ...
    Enabled {
        ...
        /// at call time with the SuperWeBuild upsell prose. Set by the host from
...
/// modal instead.
pub(crate) const TIER_RESTRICTED_UPSELL: &str = "Video generation is a SuperWeBuild feature and isn't available on the free or X Basic tier. Let the user know they can unlock image and video generation by upgrading to SuperWeBuild: https://grok.com/supergrok?referrer=grok-build. Do not retry this tool.";
