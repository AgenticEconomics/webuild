...
use crate::implementations::webuild_build::task::types::SubagentCancelOutcome;
...
impl crate::types::tool_metadata::ToolMetadata for KillTaskTool {
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        let mut arms =
            crate::implementations::webuild_build::task_output::background_bash_requires_exprs();
        arms.push(task_tool);
        Expr::Or(arms)
    }
}
