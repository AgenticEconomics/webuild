...
// Re-export the shared WeBuildIntegerSchema from types module
pub use crate::types::WeBuildIntegerSchema;
use ripgrep::rg_path;
...
crate::register_resource!("webuild_build", "Grep", GrepParams);
