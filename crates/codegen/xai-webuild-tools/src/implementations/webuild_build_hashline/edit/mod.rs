...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::webuild_build_hashline::anchor::split_lines;
        use crate::implementations::webuild_build_hashline::edit::apply::anchor_suffix;
        use crate::implementations::webuild_build_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    fn test_scheme() -> Box<dyn crate::implementations::webuild_build_hashline::scheme::AnchorScheme> {
        crate::implementations::webuild_build_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
