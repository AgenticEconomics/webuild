...
pub enum SkillScope {
    /// cwd/.webuild/skills (highest priority)
    Local = 0,
...
mod tests {
    ...
    fn extracts_skill_name() {
        assert_eq!(
            skill_name_from_path("/home/user/.webuild/skills/deploy/SKILL.md"),
            Some("deploy"),
        );
    }
    ...
    fn nested_path() {
        assert_eq!(
            skill_name_from_path("/repo/.webuild/skills/my-skill/SKILL.md"),
            Some("my-skill"),
        );
    }
