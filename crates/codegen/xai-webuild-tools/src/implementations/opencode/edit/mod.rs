...
use crate::implementations::webuild_build::search_replace::CONTEXT_LINES;
use crate::implementations::webuild_build::search_replace::helpers::{
...
// are imported from `webuild_build::search_replace::helpers` — shared across
// both the webuild_build and opencode edit tools.
