//! ToolBridge: adapter that wraps `xai-webuild-tools`'s `ToolRegistry` and
...
impl ToolBridge {
    ...
    /// `Some("get_task_output")` for the webuild_build agent and `None` for
    ...
    pub async fn delete_scheduled_task(
        ...
        use crate::implementations::webuild_build::scheduler::types::{
...
mod tests {
    ...
    fn tool_kind_returns_registered_kind_per_namespace_and_none_for_unknown() {
        ...
        // PascalCase + webuild_build's snake_case in one registry
