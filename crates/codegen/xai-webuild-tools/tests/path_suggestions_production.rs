...
//! Run:
//! ```bash
//! cargo test -p xai-webuild-tools --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use xai_webuild_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &xai_webuild_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_webuild_sessions_internal_path() {
