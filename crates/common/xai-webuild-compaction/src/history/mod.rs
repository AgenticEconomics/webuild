...
//! string/text manipulation. Harness-bound extraction (WeBuild chat's
//! `WeBuildConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `WeBuildMessage` assembly) stays in the harness crate.
