...
//! subsystem. The WeBuild chat's step-level intra prompt
...
/// `xai-webuild-shell::session::helpers::session_compact::build_compaction_prompt`
...
/// (mirrors `xai-webuild-shell`'s `SELF_SUMMARIZATION_PROMPT`). Framed
