...
//! ```
//!
//! Per-harness concerns stay in the product host (for example `xai-webuild-shell`): the triggers, the
...
mod tests {
    ...
    #[tokio::test]
    async fn full_replace_produces_webuild_build_history_shape() {
        let llm_turns = vec![
